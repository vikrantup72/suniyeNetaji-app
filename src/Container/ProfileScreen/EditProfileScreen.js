...
const EditProfileScreen = () => {
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      formData.append('party', party === -1 ? '' : party); // Send blank if "None" is selected
          ...
          <View style={styles.inputfieldsty}>
            <Picker
              ...
              onValueChange={(itemValue, itemIndex) => {
                setParty(itemValue); // Update party to store the ID
                ...
                renderItem={({item}) => (
                  <View>
                    <View
                      ...
                      <View>
                        <Text style={[styles.camponytxtsty, {width: RfW(220)}]}>
                          {item.company}
                        </Text>
                        <Text
                          style={[
